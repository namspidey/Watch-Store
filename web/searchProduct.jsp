<%-- 
    ...
    Created on : Jun 27, 2023, 9:53:52 PM
    Author     : namde
--%>
   ...
   <body class="main-layout position_head">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item active">
                                 <a class="nav-link" href="glasses.html">Our Watches</a>
                              </li>
                              <li class="nav-item">
      ...
      <div class="glasses">
          ...
          <div style="padding-left: 20px" >
              <button style="font-size: 20px;border: solid 2px;border-radius: 20px">
          ...
          <div class="container">
            ...
            <div class="row">
               <div class="col-md-10 offset-md-1">
                  <div class="titlepage">
                      <h2>Result for : "${requestScope.searchName}"</h2>
         ...
         <div class="container-fluid">
            <div class="row">
                <c:forEach items="${requestScope.listByName}" var="c">
